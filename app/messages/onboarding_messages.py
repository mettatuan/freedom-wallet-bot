"""
7-Day VIP Onboarding Journey Messages

Messages for ONBOARDING_7_DAY program (new VIP users who unlocked premium).
Used by: app.services.program_manager, app.handlers.user.onboarding
"""
