...
def get_user_state_safe(user_id: int) -> UserState:
    ...
    Usage:
        from bot.core.state_machine import get_user_state_safe
...
def transition_user_safe(user_id: int, new_state: UserState, reason: str = None) -> bool:
    ...
    Usage:
        from bot.core.state_machine import transition_user_safe, UserState
...
def check_referral_milestone(user_id: int) -> Optional[UserState]:
    ...
    Usage:
        from bot.core.state_machine import check_referral_milestone
