...
class PaymentService:
    ...
    def generate_transfer_code(user_id: int) -> str:
        ...
        Example: User 1299465308 → FW1299465308
        """
        return f"FW{user_id}"
    ...
    def format_payment_message(payment_info: Dict[str, Any]) -> str:
        ...
        message = f"""
💳 **THANH TOÁN {payment_info['package']}**

━━━━━━━━━━━━━━━━━━━━━
📱 **QUÉT MÃ QR:**
━━━━━━━━━━━━━━━━━━━━━

👇 Quét mã QR bên dưới bằng app ngân hàng
...
👤 **Người nhận:** {payment_info['account_name']}
💳 **Số TK:** `{payment_info['account_number']}`
...
• **PHẢI ghi đúng nội dung:** {payment_info['transfer_code']}
• Hệ thống tự động kích hoạt trong 5-10 phút
• Nếu chưa kích hoạt sau 15 phút, liên hệ Admin

━━━━━━━━━━━━━━━━━━━━━
🎁 **SAU KHI THANH TOÁN:**
━━━━━━━━━━━━━━━━━━━━━

✅ Tài khoản Premium kích hoạt tự động
✅ Nhận thông báo xác nhận
✅ Sử dụng ngay tất cả tính năng
